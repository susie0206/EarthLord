...
//
//  坐标转换工具
//  解决中国 GPS 偏移问题：WGS-84（GPS 硬件）→ GCJ-02（中国地图）
//
...
class CoordinateConverter {
    ...
    /// - Returns: GCJ-02 坐标数组
    static func convertCoordinates(_ wgs84Coordinates: [CLLocationCoordinate2D]) -> [CLLocationCoordinate2D] {
